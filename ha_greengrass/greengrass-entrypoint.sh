...
set +m
cp -r /app/ /var/lib/veea/greengrasspv/
echo "Copying /app to peristent volume"

export GGC_ROOT_PATH=/var/lib/veea/greengrasspv/app/greengrass/v2
echo "exporting GGC_ROOT_PATH as /var/lib/veea/greengrasspv/greengrass/v2"

# Path that initial installation files are copied to
INIT_JAR_PATH=/var/lib/veea/greengrasspv/app/greengrassv2
#Default options
